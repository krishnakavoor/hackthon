...
@section('pageDescription', 'Privacy Policy and information from biggest stock market screener kavmy.com.')
@section('pageKeywords', 'Privacy Policy and information stock market live feeds, NYSE, NASDAQ , TSX , TSXV ,LSE ,Canada Markets,USA markets,Market News, Business News')
@section('content')
...
<div  class="container">
    <div class="row">
        <div class="col-sm-12">
            ...
            <div >We collect information from you when you register on our site, subscribe to a newsletter, respond to a survey, fill out a form, Use Live Chat, Open a Support Ticket or enter information on our site.</div>
            ...
            <div >      <strong>•</strong> To personalize your experience and to allow us to deliver the type of content and product offerings in which you are most interested.</div>
            <div >      <strong>•</strong> To improve our website in order to better serve you.</div>
            <div >      <strong>•</strong> To allow us to better service you in responding to your customer service requests.</div>
            <div >      <strong>•</strong> To administer a contest, promotion, survey or other site feature.</div>
            <div >      <strong>•</strong> To quickly process your transactions.</div>
            <div >      <strong>•</strong> To ask for ratings and reviews of services or products</div>
            <div >      <strong>•</strong> To follow up with them after correspondence (live chat, email or phone inquiries)</div>
            &nbsp;
            ...
            <div ><strong>We use cookies to:</strong></div>
            <div >      <strong>•</strong> Understand and save user's preferences for future visits.</div>
            <div >      <strong>•</strong> Keep track of advertisements.</div>
            ...
            <div >You can choose to have your computer warn you each time a cookie is being sent, or you can choose to turn off all cookies. You do this through your browser settings. Since browser is a little different, look at your browser's Help Menu to learn the correct way to modify your cookies.</div>
            <div ><strong>If users disable cookies in their browser:</strong></div>

            <div >If you turn cookies off, some features will be disabled. Some of the features that make your site experience more efficient and may not function properly.</div>
            &nbsp;
            <div >However, you will still be able to place orders over the telephone by contacting customer service.</div>
            &nbsp;
            <div ><strong>Third-party disclosure</strong></div>
            &nbsp;
            <div ><strong>Do we disclose the information we collect to Third-Parties?</strong></div>
            <div >We sell,trade, or otherwise transfer to outside parties your name, address,city,town, any form or online contact identifier email, name of chat account etc., screen name or user names, phone number, cookie number, ip address device serial #, unique device identifier, photo, video or audio file of child Personally Identifiable Information.</div>
            &nbsp;
            ...
            <div >Google, as a third-party vendor, uses cookies to serve ads on our site. Google's use of the DART cookie enables it to serve ads to our users based on previous visits to our site and other sites on the Internet. Users may opt-out of the use of the DART cookie by visiting the Google Ad and Content Network privacy policy.</div>
            <div ><strong>We have implemented the following:</strong></div>
            <div >      <strong>•</strong> Remarketing with Google AdSense</div>
            <div >      <strong>•</strong> Google Display Network Impression Reporting</div>
            <div >      <strong>•</strong> Demographics and Interests Reporting</div>
            <div >      <strong>•</strong> DoubleClick Platform Integration</div>
            &nbsp;
            <div >We, along with third-party vendors such as Google use first-party cookies (such as the Google Analytics cookies) and third-party cookies (such as the DoubleClick cookie) or other third-party identifiers together to compile data regarding user interactions with ad impressions and other ad service functions as they relate to our website.</div>
            <div ><strong>Opting out:
            ...
            <div >You will be notified of any Privacy Policy changes:</div>
            <div >      <strong>•</strong> Via Email</div>
            ...
            <div >      <strong>•</strong> By chatting with us or by sending us a support ticket</div>
            ...
            <div >      <strong>•</strong> Send you additional information related to your product and/or service</div>
            ...
            <div >info@kavmy.com and we will promptly remove you from <strong>ALL</strong> correspondence.</div>
            <strong>
                <span id="ourCon"></span>
            </strong>
            ...
            <address>
                <strong>kavmy.com</strong><br/>
                <div >S3 SNR Complex</div>
                <strong>Bangalore, Karnataka 560093</strong>
                <div >info@kavmy.com</div>
                <div >Last Edited on 2016-11-29</div>
            </address>
            &nbsp;
        </div>
    </div>
